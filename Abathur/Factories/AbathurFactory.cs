...
namespace Abathur.Factory
{
    public class AbathurFactory
    {
          ...
          params string[] modules)
        {
            ...
            Type[] array = GetTypes<IReplaceableModule>(assembly).ToArray();
            Abathur abathur = (Abathur)this.Create(gameSettings, essence, logger, typeList, array);
            return abathur;
        }
